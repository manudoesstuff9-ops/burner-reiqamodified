#this is the origianl readme from the old paper on reiqa from cvpr 
...
1. KADIS-10k : Download [KADIS-10k](http://database.mmsp-kn.de/kadid-10k-database.html) dataset. Store this data in the ```training_data/kadis10k``` directory. Note we do not use the synthetically distorted images as in CONTRIQUE.
